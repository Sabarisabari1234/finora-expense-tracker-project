...
function AddExpenseDialog({ onAddExpense, theme }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger
        render={
          <button className="flex items-center gap-2 rounded-lg bg-[#23355d] px-4 py-2.5 text-sm font-medium text-white hover:opacity-90">
            <Plus size={18} />
            Add expense
          </button>
        }
